...
void AP_Motors6DOF::setup_motors(motor_frame_class frame_class, motor_frame_type frame_type)
{
    ...
    case SUB_FRAME_CUSTOM: // custon frame added for our specific use case
        ...
        add_motor_raw_6dof(AP_MOTORS_MOT_5, 1.0f, 1.0f, 0, 1.0f, 0, 0, 5);               // updwards left thruster (z)
        add_motor_raw_6dof(AP_MOTORS_MOT_6, 0, -0.83509514, 0, 1.0f, 0, 0, 6);           // updwards front thruster (z)
        break;
